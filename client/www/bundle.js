    ...
    value: function render() {
      if (this.props.selectedTab === 'leaderboard') {
        return _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(Table, { data: this.props.recordsList, rowStyle: this.rowStyle, tableStyle: this.tableStyle })
        );
      } else {
        return null;
      }
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      data.map(function (row, key) {
        return _react2.default.createElement(TableRow, { row: row, key: key });
      })
    )
  );
};
...
var TableRow = function TableRow(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'td',
      { key: row.numberCorrect },
      row.numberCorrect / (row.numberCorrect + row.numberIncorrect) * 100 + ' %'
    )
  );
};
...
var _navTopBar = __webpack_require__(61);

var _navTopBar2 = _interopRequireDefault(_navTopBar);

var _navSideBar = __webpack_require__(62);

var _navSideBar2 = _interopRequireDefault(_navSideBar);

var _infoSideBar = __webpack_require__(25);

var _infoSideBar2 = _interopRequireDefault(_infoSideBar);

var _leaderBoard = __webpack_require__(24);
...
var _problemGen = __webpack_require__(60);
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.inProgressBoolUpdate = _this.inProgressBoolUpdate.bind(_this);
    _this.questionsLeftUpdate = _this.questionsLeftUpdate.bind(_this);
    _this.getUserInfo = _this.getUserInfo.bind(_this);
    _this.getLeaderBoard = _this.getLeaderBoard.bind(_this);
    _this.numberCorrectUpdate = _this.numberCorrectUpdate.bind(_this);
    _this.numberIncorrectUpdate = _this.numberIncorrectUpdate.bind(_this);
    _this.resetCounts = _this.resetCounts.bind(_this);
    _this.questionsLeftUpdate = _this.questionsLeftUpdate.bind(_this);
    _this.inProgressBoolUpdate = _this.inProgressBoolUpdate.bind(_this);
    _this.correctArrayUpdate = _this.correctArrayUpdate.bind(_this);
    _this.incorrectArrayUpdate = _this.incorrectArrayUpdate.bind(_this);
    _this.showChoosePathMode = _this.showChoosePathMode.bind(_this);
    _this.startNewGame = _this.startNewGame.bind(_this);
  ...
  _createClass(App, [{
    ...
    value: function getIndex() {
      ...
      _axios2.default.get('/git').then(function (result) {
    ...
    value: function startTimer() {
      ...
      setTimeout(function () {
        if (_this3.state.inProgressBool) {
          _this3.setState({
            timeElapsed: Date.now() - _this3.state.startTime
          });
          _this3.startTimer();
        }
      }, 1);
    ...
    value: function inProgressBoolUpdate() {
      ...
      this.setState({
        ...
        if (_this4.state.inProgressBool) {
          _this4.startTimer();
        } else {
          _this4.setState({
            timeElapsed: 0
    ...
    value: function questionsLeftUpdate(cb) {
      var _this5 = this;
    ...
    key: 'showChoosePathMode',
    value: function showChoosePathMode() {
      this.setState({
        choosePathMode: true
      });
    }
    ...
    value: function startNewGame(operator) {
      ...
      this.setState({
        ...
        _this6.newQuestion(operator);
        _this6.resetCounts();
        _this6.inProgressBoolUpdate();
      });
    }
  }, {
    key: 'getUserInfo',
    ...
    key: 'updateUserInfo',
    value: function updateUserInfo(object) {
      var _this8 = this;
      ...
      this.setState({
        ...
        return console.log('totalUserCorrect', _this8.state.totalUserCorrect);
      });
    }
  }, {
    key: 'getLeaderBoard',
    value: function getLeaderBoard() {
      ...
      _axios2.default.post('/allRecords', {
    ...
    key: 'handleSignUp',
    value: function handleSignUp(obj) {
      var _this10 = this;

      _axios2.default.post('/signup', obj).then(function (result) {
        if (result.data === false) {
          alert('username already exists');
        } else {
          _this10.setState({ "isLoggedIn": true,
    ...
    key: 'handleLogin',
    value: function handleLogin(obj) {
      var _this11 = this;

      _axios2.default.post('/login', obj).then(function (result) {
        if (result.data === false) {
          alert('Please try again or Create New Account');
        } else {
          _this11.setState({ "isSignedUp": true,
            "isLoggedIn": true,
            "username": result.data }, function () {
            return _this11.getUserInfo();
          });
        }
      });
    }
...
var _questionAnswer = __webpack_require__(58);
...
var Game = function (_React$Component) {
  ...
  function Game(props) {
    ...
    _this.finalTimeUpdate = _this.finalTimeUpdate.bind(_this);
    _this.saveNewScore = _this.saveNewScore.bind(_this);
    return _this;
  }

  _createClass(Game, [{
    key: 'finalTimeUpdate',
    value: function finalTimeUpdate(cb) {
      this.setState({
    ...
    key: 'saveNewScore',
    value: function saveNewScore() {
      var _this2 = this;

      var newScore = this.determineNewScore(this.state.finalTime, this.props.numberCorrect, this.props.numberIncorrect);
      _axios2.default.post('/newRecord', {
      ...
      _axios2.default.post('/updateUser', {
        'username': this.props.username,
        'highScore': newScore,
        ...
        return _this2.props.updateUserInfo(user);
      });
    }
  }, {
    key: 'render',
...
var QuestionAnswer = function (_React$Component) {
	...
	_createClass(QuestionAnswer, [{
		...
		value: function findCorrect(answer, question) {
			...
			this.props.questionsLeftUpdate(function (questionsLeft) {
				if (answer === _this2.props.correctAnswer) {
					_this2.props.correctArrayUpdate(question);
					_this2.props.numberCorrectUpdate();
				} else {
					_this2.props.incorrectArrayUpdate(question);
					_this2.props.numberIncorrectUpdate();
				}
				if (questionsLeft === 0) {
					_this2.props.finalTimeUpdate(function () {
						_this2.props.saveNewScore();
						console.log('final time update');
					});
					_this2.props.inProgressBoolUpdate();
				} else {
					_this2.props.newQuestion();
				}
			});
		}
	}, {
...
var Timer = function Timer(props) {
	return _react2.default.createElement(
		...
		null,
		'Time Elapsed: ',
		(props.timeElapsed / 1000).toFixed(2)
	);
};
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.props.correctArray.map(function (correctQuestion, index) {
            return _react2.default.createElement(
              'li',
              { key: index },
              correctQuestion
        ...
        _react2.default.createElement(
          'h2',
          {
            ...
            onClick: function onClick() {
              _this2.props.startNewGame(_this2.props.problemType);
            }
          },
          'Play Again'
        ),
        _react2.default.createElement(
          'h2',
          {
            style: this.buttonStyle,
            onClick: function onClick() {
              _this2.props.showChoosePathMode();
            }
          },
          'Choose Another Path'
        )
...
var NavTopBar = function (_React$Component) {
  ...
  function NavTopBar(props) {
    ...
    var _this = _possibleConstructorReturn(this, (NavTopBar.__proto__ || Object.getPrototypeOf(NavTopBar)).call(this, props));
  ...
  _createClass(NavTopBar, [{
    key: 'selectedTabUpdate',
    value: function selectedTabUpdate(selection) {
      this.setState({
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'li',
            {
              style: this.listItemStyle,
              onClick: function onClick() {
                _this2.props.getLeaderBoard();
                _this2.selectedTabUpdate('leaderboard');
              } },
            'LeaderBoard'
          ),
          _react2.default.createElement(
            'li',
            {
              style: this.listItemStyle,
              onClick: function onClick() {
                _this2.selectedTabUpdate('tutorial');
              } },
            'Tutorial'
          )
        ),
      ...
      if (this.props.choosePathMode) {
        if (this.props.inProgressBool) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'h2',
              { style: this.selectStyle, onClick: function onClick() {
            ...
            _react2.default.createElement(
              'h2',
              { style: this.selectStyle, onClick: function onClick() {
                  _this2.props.startNewGame(_underscore2.default.sample(['+', '/', '*', '-']));
                } },
              'Random'
            )
          );
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "p",
            null,
            "It's like HQ trivia but it's only for math, you can't win money, and we have a tenth of a percentage of their userbase"
          )
        ),
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            "button",
            { onClick: function onClick() {
                return _this2.props.handleLogin({ 'username': _this2.state.username, 'password': _this2.state.password });
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "button",
            { onClick: this.props.goToSignUp, style: signUpButtonStyle },
            "Sign Up"
          )
        ),
        _react2.default.createElement(
          "p",
          { style: smallPrintStyle },
          "\xA9 2018 QuikMath Fine Print Goes Here"
        )
      );
    }
  }]);
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ style: signUpButtonStyle, onClick: function onClick() {
								return _this2.props.handleSignUp({ 'username': _this2.state.username, 'password': _this2.state.password });
							} },
						'Sign Up'
					)
				),
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ style: loginButtonStyle, onClick: this.props.goToLogin },
						'I have an account!'
					)
				),
				_react2.default.createElement(
