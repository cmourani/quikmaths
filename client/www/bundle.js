      ...
      if (this.props.selectedTab === 'leaderboard') {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'ul',
            null,
            this.props.recordsList.map(function (record, i) {
              return _react2.default.createElement(
                'li',
                { key: i },
                'User:',
                ...
                record.time,
                ' Accuracy: ',
                record.numberCorrect / (record.numberCorrect + record.numberIncorrect) * 100 + ' %'
              );
            })
          )
        );
...
var App = function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.problemTypeUpdate = _this.problemTypeUpdate.bind(_this);
    ...
    value: function startTimer() {
      ...
      setTimeout(function () {
        if (_this3.state.inProgressBool) {
          _this3.setState({
            timeElapsed: _this3.state.timeElapsed + 1
          });
          _this3.startTimer();
        }
      }, 1);
    ...
    value: function handleSignUp(obj) {
      ...
      _axios2.default.post('/signup', obj).then(function (result) {
        if (result.data === false) {
          ...
          _this9.setState({ "isLoggedIn": true,
    ...
    value: function handleLogin(obj) {
      ...
      _axios2.default.post('/login', obj).then(function (result) {
        ...
        if (result.data === false) {
          ...
          _this10.setState({ "isSignedUp": true,
            "isLoggedIn": true,
            "username": result.data });
        }
      });
